...
namespace {
    ...
    constexpr static symmetric_ciphers::__aes_u8 MUL_9[256] = {
    ...
    constexpr static symmetric_ciphers::__aes_u8 MUL_11[256] = {
    ...
    constexpr static symmetric_ciphers::__aes_u8 MUL_13[256] = {
    ...
    constexpr static symmetric_ciphers::__aes_u8 MUL_14[256] = {
